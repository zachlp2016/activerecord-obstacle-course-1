...
# ----------------------
  ...
  it '2. finds order id of smallest order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    order_id = Order.select(:id).order("amount asc").limit(1).find_by('id').id
  ...
  it '3. finds order id of largest order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    order_id = Order.select(:id).order("amount desc").limit(1).find_by('id').id
    # ------------------------------------------------------------
  ...
  it '6. finds multiple orders by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders = Order.find(5, 1, 3, 14).sort
    # ------------------------------------------------------------
